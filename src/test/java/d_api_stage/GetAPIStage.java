...
public class GetAPIStage implements Command {
...
//                    next 2 line, amar nai
                    if (data.get(exec) != null && data.get(exec).equalsIgnoreCase(flag)) {
                        ...
                        if(jsonPrep.payload != null) {
                            ...
                            Object quoteNo = jsonPrep.jPath(getResponse, quoteNode);
